...
BOW_VARIANCE            FCB   $20        ; Establish baseline for sensors
PORT_VARIANCE           FCB   $45
                     
MID_VARIANCE            FCB   $20
STARBOARD_VARIANCE      FCB   $20
...
; subroutine section
;***************************************************************************************************
DISPATCHER        JSR   ALLOW_START                        ; Start of the Dispatcher
                  RTS

ALLOW_START      CMPA  #START                                ; Verify if the robot's state is START
...
VERIFY_LEFT_ALIGN CMPA  #LEFT_ALIGN                         ; Verify if the robot's state is LEFT_ALIGN
                  ...
                  JSR   IMPLEMENT_LEFT_ALIGN          ; Validate LEFT_ALIGN state
                  RTS
...
LEFT              LDAA    SENSOR_BOW                                                              
                  ADDA    BOW_VARIANCE                                                                 
                  CMPA    BASE_BOW                                                               
                  BPL     IMPLEMENT_LEFT_ALIGN                                                        
                  BMI     EXIT

IMPLEMENT_LEFT_ALIGN:
                  MOVB    #FWD, CRNT_STATE                                                        
                  JSR     INIT_FWD                                                                
                  BRA     EXIT                                                                    
